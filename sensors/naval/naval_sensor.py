...
Gera dados simulados de sensor naval de forma autônoma:
  ...
  - Detecção de anomalia magnética (possível submarino / objeto metálico)
  - Contagem de contatos de superfície no alcance
...
class NavalSensor:
    ...
    def read(self):
        ...
        # Anomalia magnética: baixa probabilidade, mas quando ocorre é significativa
